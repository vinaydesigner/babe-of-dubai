            ...
            <>
              <div key={curElemt.id} className={styles.thumouterbox}>
                ...
                <div className={styles.modelsname}>
                  ...
                  <span>
                    <Image src="/images/selfie.svg" width={20} height={20} />
                  </span>
                  <span>
                    <Image src="/images/video.svg" width={20} height={20} />
                  </span>
                </div>
                <div className={styles.modelslocation}>
                  <span>{curElemt.location}</span>
                  <span>
                    AED <strong> {curElemt.halfHrInCallRate} </strong>{" "}
                    <strong> {curElemt.halfHrOutCallRate} </strong>{" "}
                  </span>
                </div>
              </div>
            </>
